...
async function callClaude(messages, system) {
  const res = await fetch("https://api.anthropic.com/v1/messages", {
    ...
    headers: {
      ...
      "x-api-key": "YOUR_ANTHROPIC_API_KEY", // Ensure you add your actual API key here
...
Write a warm, personal 2-sentence auto-response using their name, acknowledging their request and letting them know our team will call them within 24 hours.`
        : `A volunteer named ${form.name} from ${form.city || "India"} has registered with Medic Wellness NGO for the role: "${form.role || "General volunteering"}".
Write a warm, personal 2-sentence auto-response using their name, welcoming them to the team and letting them know they will receive an onboarding email within 48 hours.`;
            ...
            <div style={{ background: COLORS.card, borderRadius: 20, padding: "24px", border: `1.5px solid ${COLORS.border}` }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                {[
                  ...
                  <div key={title} 
                  style={{ background: COLORS.accent, borderRadius: 14, padding: "16px", border: `1px solid ${COLORS.accentStrong}` }}>
